...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main class="ops-page"><section class="ops-shell">
        <div class="ops-hero"><div><span class="eyebrow">AER_AEROPUERTO</span><h1>Aeropuertos</h1><p>Aeropuertos por nombre, ciudad, pais y aerolinea asociada.</p></div><div class="ops-actions"><a class="ops-button secondary" runat="server" href="~/Modules/Dashboard.aspx">Modulos</a><a class="ops-button" href="#aeropuertoForm">Agregar aeropuerto</a></div></div>
        ...
        <section id="aeropuertoForm" class="ops-panel ops-form-panel">
            <h2>Agregar aeropuerto</h2>
            <p>Formulario preparado para AER_AEROPUERTO.</p>
            <div class="ops-form-grid">
                <div class="ops-field"><label>ID aeropuerto</label><input class="ops-input" name="ID_aeropuerto" placeholder="31" /></div>
                <div class="ops-field"><label>Nombre</label><input class="ops-input" name="Nombre" placeholder="Aero 31" /></div>
                ...
                <div class="ops-field"><label>ID aerolinea</label><input class="ops-input" name="ID_AEROLINEA" placeholder="1" /></div>
            </div>
