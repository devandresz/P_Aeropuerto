...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main class="ops-page"><section class="ops-shell">
        <div class="ops-hero"><div><span class="eyebrow">AER_TRIPULACION</span><h1>Tripulacion</h1><p>Personal de tripulacion con nombre, apellido y rol.</p></div><div class="ops-actions"><a class="ops-button secondary" runat="server" href="~/Modules/Dashboard.aspx">Modulos</a><a class="ops-button" href="#tripulacionForm">Nuevo tripulante</a></div></div>
        ...
        <section id="tripulacionForm" class="ops-panel ops-form-panel">
            <h2>Nuevo tripulante</h2>
            <p>Formulario preparado para AER_TRIPULACION.</p>
            <div class="ops-form-grid">
                <div class="ops-field"><label>ID tripulacion</label><input class="ops-input" name="ID_tripulacion" placeholder="31" /></div>
                <div class="ops-field"><label>Nombre</label><input class="ops-input" name="Nombre" placeholder="Trip31" /></div>
                <div class="ops-field"><label>Apellido</label><input class="ops-input" name="Apellido" placeholder="Ape31" /></div>
                <div class="ops-field"><label>Rol</label><input class="ops-input" name="Rol" placeholder="Rol31" /></div>
            </div>
